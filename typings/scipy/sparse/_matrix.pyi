...
class spmatrix:
    ...
    def __pow__(self, power): # -> csc_array | csc_matrix | csr_array | csr_matrix | coo_array | coo_matrix | dia_array | Any | dia_matrix | NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
        ...

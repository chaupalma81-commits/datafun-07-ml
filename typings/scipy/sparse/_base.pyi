...
class _spbase(SparseABC):
    ...
    def __matmul__(self, other): # -> NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
        ...
    ...
    def todense(self, order=..., out=...): # -> NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
        """
    ...
    def sum(self, axis=..., dtype=..., out=...): # -> Any | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
        """
    ...
    def mean(self, axis=..., dtype=..., out=...): # -> ndarray[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | ndarray[Any, dtype[Any]] | Any | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
        """

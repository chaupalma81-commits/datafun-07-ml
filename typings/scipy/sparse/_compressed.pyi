...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def diagonal(self, k=...): # -> ndarray[tuple[int], dtype[complex128 | float64 | numpy.bool[builtins.bool] | complexfloating[_NBitLongDouble, _NBitLongDouble] | complexfloating[_32Bit, _32Bit] | floating[_NBitLongDouble] | floating[_32Bit] | signedinteger[_NBitShort] | signedinteger[_NBitIntC] | signedinteger[_NBitLongLong] | signedinteger[_NBitByte] | unsignedinteger[_NBitShort] | unsignedinteger[_NBitIntC] | unsignedinteger[_NBitLongLong] | unsignedinteger[_NBitByte]]] | _Array1D[Any | numpy.bool[builtins.bool] | signedinteger[_NBitByte] | unsignedinteger[_NBitByte] | signedinteger[_NBitShort] | unsignedinteger[_NBitShort] | signedinteger[_NBitIntC] | unsignedinteger[_NBitIntC] | signedinteger[_NBitLongLong] | unsignedinteger[_NBitLongLong] | floating[_32Bit] | float64 | floating[_NBitLongDouble] | complexfloating[_32Bit, _32Bit] | complex128 | complexfloating[_NBitLongDouble, _NBitLongDouble]]:
        ...
    
    def sum(self, axis=..., dtype=..., out=...): # -> _Matrix[Incomplete] | Any | NDArray[Any] | matrix[Any, Any]:

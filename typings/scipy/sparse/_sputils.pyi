...
supported_dtypes = ...
_upcast_memo = ...
def upcast(*args): # -> bool_ | byte | ubyte | short | ushort | intc | uintc | type | longlong | ulonglong | float32 | type[float64] | longdouble | complex64 | type[complex128] | clongdouble:
...
def upcast_char(*args): # -> bool_ | byte | ubyte | short | ushort | intc | uintc | type | longlong | ulonglong | float32 | type[float64] | longdouble | complex64 | type[complex128] | clongdouble:
...
def getdtype(dtype, a=..., default=...): # -> bool_ | byte | ubyte | short | ushort | intc | uintc | longlong | ulonglong | float32 | type[float64] | longdouble | complex64 | type[complex128] | clongdouble:

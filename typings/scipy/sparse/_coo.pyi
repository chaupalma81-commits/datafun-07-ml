...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    def dot(self, other): # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[()], Any] | Any | coo_array:
    ...
    def tensordot(self, other, axes=...): # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[()], Any] | Any | coo_array:

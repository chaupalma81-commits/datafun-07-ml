...
"""
__all__ = ['onenormest']
def onenormest(A, t=..., itmax=..., compute_v=..., compute_w=...): # -> tuple[Any | _Array1D[Incomplete] | Literal[0], ...] | tuple[Any | Literal[0], ...] | tuple[Any | Literal[0], _Array1D[Incomplete]] | tuple[Any | Literal[0]] | Any | Literal[0]:
    """

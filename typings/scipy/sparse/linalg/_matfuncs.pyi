...
def expm(A): # -> ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | csc_array | Any | ndarray[_AnyShape, dtype[float64]] | NotImplementedType:
    """
...
def matrix_power(A, power): # -> csc_array | csc_matrix | csr_array | csr_matrix | coo_array | coo_matrix | dia_array | Any | dia_matrix | NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
    """

...
class LinearOperator:
    ...
    def rmatvec(self, x): # -> NDArray[Any] | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]]:
    ...
    def matmat(self, X): # -> matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
    ...
    def rmatmat(self, X): # -> matrix[_AnyShape, dtype[Any]] | matrix[Any, Any] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | Any:
    ...
    def __mul__(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
        ...
    
    def __truediv__(self, other): # -> _ScaledLinearOperator:
        ...
    
    def dot(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
    ...
    def __matmul__(self, other): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
        ...

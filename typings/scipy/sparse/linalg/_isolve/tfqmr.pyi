...
__all__ = ['tfqmr']
def tfqmr(A, b, x0=..., *, rtol=..., atol=..., maxiter=..., M=..., callback=..., show=...): # -> tuple[ndarray[tuple[int], dtype[Any]], Literal[0]] | tuple[_Array1D[Incomplete] | Any | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]], Literal[0]] | tuple[_Array1D[Incomplete] | Any | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]], Literal[-1]] | tuple[Any, Literal[0]] | tuple[_Array1D[Incomplete] | Any | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]], int | Any]:
    """

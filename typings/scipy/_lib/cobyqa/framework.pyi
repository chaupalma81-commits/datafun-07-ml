...
class TrustRegion:
    ...
    def get_constraint_linearizations(self, x): # -> tuple[NDArray[Incomplete], NDArray[Any], NDArray[Incomplete], NDArray[Any]]:
        """
    ...
    def get_geometry_step(self, k_new, options): # -> ndarray[Any, Any] | NDArray[float64]:
        """

...
def generate_multimethod(argument_extractor: ArgumentExtractorType, argument_replacer: ArgumentReplacerType, domain: str, default: typing.Callable | None = ...): # -> _Wrapped[Callable[..., Any], tuple[Dispatchable, ...], Callable[..., Any], Any]:
    """
    Generates a multimethod.
...
def wrap_single_convertor(convert_single): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], NotImplementedType | list[Any]]:
    """
...
def wrap_single_convertor_instance(convert_single): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], NotImplementedType | list[Any]]:
    """
    Wraps a ``__ua_convert__`` defined for a single element to all elements.
    If any of them return ``NotImplemented``, the operation is assumed to be
    undefined.

...
def eager_warns(warning_type, *, match=..., xp): # -> WarningsChecker | _GeneratorContextManager[None, None, None]:
...
def xp_assert_close_nulp(actual, desired, *, nulp=..., check_namespace=..., check_dtype=..., check_shape=..., check_0d=..., err_msg=..., xp=...): # -> None:
    ...
...
def xp_promote(*args, broadcast=..., force_floating=..., xp): # -> tuple[Any, ...] | Array | tuple[Array | Any, ...]:
    """
...
def xp_capabilities(*, capabilities_table=..., skip_backends=..., xfail_backends=..., cpu_only=..., np_only=..., reason=..., out_of_scope=..., exceptions=..., warnings=..., allow_dask_compute=..., jax_jit=..., extra_note=...): # -> Callable[..., Any]:
...
def make_xp_pytest_param(func, *args, capabilities_table=...): # -> ParameterSet:

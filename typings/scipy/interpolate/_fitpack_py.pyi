...
@xp_capabilities(out_of_scope=True)
def splrep(x, y, w=..., xb=..., xe=..., k=..., task=..., s=..., t=..., full_output=..., per=..., quiet=...): # -> tuple[tuple[Any, Any, int], Any, Any, str | type[ValueError] | type[TypeError] | None] | tuple[Any, Any, int]:
    """
...
@xp_capabilities(out_of_scope=True)
def splint(a, b, tck, full_output=...): # -> Any | list[list[list[Any] | tuple[Any, Any] | Any] | tuple[Any, Any] | Any] | tuple[Any, Any]:
    """
...
@xp_capabilities(out_of_scope=True)
def spalde(x, tck): # -> list[list[Any] | Any]:
    """

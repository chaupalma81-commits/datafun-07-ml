...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    def derivatives(self, x): # -> list[list[list[Any] | Any] | list[Any] | Any] | list[Any]:
...
class _BivariateSplineBase:
    ...
    def __call__(self, x, y, dx=..., dy=..., grid=...): # -> _Array[tuple[int, int], float64] | _Array[tuple[()], float64]:
        """
...
class BivariateSpline(_BivariateSplineBase):
    ...
    bisplev :
        a function to evaluate a bivariate B-spline and its derivatives
    """
    def ev(self, xi, yi, dx=..., dy=...): # -> _Array[tuple[int, int], float64] | _Array[tuple[()], float64]:
        """
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    """
    def __call__(self, theta, phi, dtheta=..., dphi=..., grid=...): # -> _Array[tuple[int, int], float64] | _Array[tuple[()], float64]:
        """
        Evaluate the spline or its derivatives at given positions.
    ...
    def ev(self, theta, phi, dtheta=..., dphi=...): # -> _Array[tuple[int, int], float64] | _Array[tuple[()], float64]:
        """
        Evaluate the spline at points

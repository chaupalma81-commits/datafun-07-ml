...
class MultiUFunc:
    def __init__(self, ufunc_or_ufuncs, name=..., doc=..., *, force_complex_output=..., **default_kwargs) -> None:
        ...
...
def _(n, m, z_shape, branch_cut_shape, nout, **kwargs): # -> tuple[tuple[_ComplexLike, Any, *tuple[Any, ...], Any]]:
    ...
...
def _(diff_n): # -> dict[str, list[tuple[()] | tuple[int, int]]]:
    ...
...
def _(n, m, theta_shape, phi_shape, nout, **kwargs): # -> tuple[tuple[_ComplexLike, Any, *tuple[Any, ...], Any, Any]]:
    ...

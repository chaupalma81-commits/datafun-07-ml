...
def lu_factor(a, overwrite_a=..., check_finite=...): # -> tuple[Any | NDArray[Any], _Array1D[signedinteger[_32Bit]]] | tuple[Any, Any]:
    """
...
def lu(a, permute_l=..., overwrite_a=..., check_finite=..., p_indices=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]] | tuple[NDArray[signedinteger[_32Bit]] | NDArray[Incomplete], ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]] | tuple[ndarray[_AnyShape, dtype[Any]] | Any | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | Any | NDArray[Any]] | tuple[NDArray[Incomplete] | Any | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | Any | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | Any | NDArray[Any]] | tuple[NDArray[Incomplete] | _Array1D[signedinteger[_32Bit]] | NDArray[signedinteger[_32Bit]], ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | Any, ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | Any]:
    """

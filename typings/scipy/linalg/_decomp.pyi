...
def eig(a, b=..., left=..., right=..., overwrite_a=..., overwrite_b=..., check_finite=..., homogeneous_eigvals=...): # -> NDArray[Any] | tuple[NDArray[Any] | Any, Any, Any] | tuple[NDArray[Any] | Any, Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
    """
...
@_apply_over_batch(('a', 2), ('b', 2))
def eigh(a, b=..., *, lower=..., eigvals_only=..., overwrite_a=..., overwrite_b=..., type=..., check_finite=..., subset_by_index=..., subset_by_value=..., driver=...):
    """
...
@_apply_over_batch(('a', 2), ('b', 2))
def eigvals(a, b=..., overwrite_a=..., check_finite=..., homogeneous_eigvals=...): # -> NDArray[Any] | tuple[NDArray[Any] | Any, Any, Any] | tuple[NDArray[Any] | Any, Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
    """
...
@_apply_over_batch(('a', 2), ('b', 2))
def eigvalsh(a, b=..., *, lower=..., overwrite_a=..., overwrite_b=..., type=..., check_finite=..., subset_by_index=..., subset_by_value=..., driver=...):
    """
...
def eigvalsh_tridiagonal(d, e, select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64], ndarray[_AnyShape, dtype[float64]]] | tuple[Any, Any]:
    """
...
@_apply_over_batch(('d', 1), ('e', 1))
def eigh_tridiagonal(d, e, eigvals_only=..., select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64], ndarray[_AnyShape, dtype[float64]]] | tuple[Any, Any]:
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> numpy._core.multiarray._Array[tuple[int, int] | Any, float64] | tuple[numpy._core.multiarray._Array[tuple[int, int] | Any, float64], numpy._core.multiarray._Array[tuple[int, int] | Any, float64]] | tuple[numpy.lib._function_base_impl._Array[_AnyShape, float64] | Any | NDArray[Any], _Array2D[float64]] | numpy.lib._function_base_impl._Array[_AnyShape, float64] | NDArray[Any] | tuple[Any, Any]:
    """

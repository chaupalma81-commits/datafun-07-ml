...
def expm(A): # -> NDArray[Any] | ndarray[tuple[()], dtype[float64] | dtype[floating[_32Bit]]]:
...
@_apply_over_batch(('A', 2))
def cosm(A): # -> NDArray[float64] | NDArray[floating[Any]] | ndarray[tuple[()], dtype[float64 | floating[_32Bit]]]:
    """
...
@_apply_over_batch(('A', 2))
def sinm(A): # -> NDArray[complex128] | NDArray[complexfloating[Any, Any]] | ndarray[tuple[()], dtype[float64 | floating[_32Bit]]]:
    """
...
@_apply_over_batch(('A', 2))
def coshm(A): # -> ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[floating[Any]]]:
    """
...
@_apply_over_batch(('A', 2))
def sinhm(A): # -> ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[floating[Any]]]:
    """
...
@_apply_over_batch(('A', 2))
def funm(A, func, disp=...): # -> Incomplete | tuple[Incomplete, float | floating[Any] | int]:
    """
...
@_apply_over_batch(('A', 2))
def signm(A, disp=...): # -> Incomplete | tuple[Any, Any | float | floating[Any] | int]:
    """

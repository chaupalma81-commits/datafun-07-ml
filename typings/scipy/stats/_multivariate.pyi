...
__all__ = ['multivariate_normal', 'matrix_normal', 'dirichlet', 'dirichlet_multinomial', 'wishart', 'invwishart', 'multinomial', 'special_ortho_group', 'ortho_group', 'random_correlation', 'unitary_group', 'multivariate_t', 'multivariate_hypergeom', 'random_table', 'uniform_direction', 'vonmises_fisher', 'normal_inverse_gamma', 'matrix_t']
...
class multivariate_normal_gen(multi_rv_generic):
    ...
    def __call__(self, mean=..., cov=..., allow_singular=..., seed=..., **kwds): # -> multivariate_normal_frozen:
    ...
    def logcdf(self, x, mean=..., cov=..., allow_singular=..., maxpts=..., abseps=..., releps=..., *, lower_limit=..., rng=...): # -> Any:
    ...
    def cdf(self, x, mean=..., cov=..., allow_singular=..., maxpts=..., abseps=..., releps=..., *, lower_limit=..., rng=...):
    ...
    def fit(self, x, fix_mean=..., fix_cov=...): # -> tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
        """Fit a multivariate normal distribution to data.
    ...
    def marginal(self, dimensions, mean=..., cov=..., allow_singular=...): # -> multivariate_normal_frozen:
        """Return a marginal multivariate normal distribution.
...
class matrix_t_gen(multi_rv_generic):
    ...
    def __call__(self, mean=..., row_spread=..., col_spread=..., df=..., seed=...): # -> matrix_t_frozen:
    ...
    def rvs(self, mean=..., row_spread=..., col_spread=..., df=..., size=..., random_state=...) -> np.ndarray:
...
class wishart_gen(multi_rv_generic):
    ...
    def mean(self, df, scale): # -> ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]] | Any:
    ...
    def rvs(self, df, scale, size=..., random_state=...): # -> ndarray[_AnyShape, dtype[float64]]:
        """Draw random samples from a Wishart distribution.
...
class wishart_frozen(multi_rv_frozen):
    ...
    def mean(self): # -> ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]] | Any:
        ...
...
class multinomial_gen(multi_rv_generic):
    ...
    def rvs(self, n, p, size=..., random_state=...): # -> NDArray[long] | NDArray[int64]:
        """Draw random samples from a Multinomial distribution.
...
class multivariate_t_gen(multi_rv_generic):
    ...
    def marginal(self, dimensions, loc=..., shape=..., df=..., allow_singular=...): # -> multivariate_t_frozen:
        """Return a marginal multivariate t-distribution.
...
class multivariate_hypergeom_gen(multi_rv_generic):
    ...
    def rvs(self, m, n, size=..., random_state=...): # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[int, ...] | Any, dtype[Any]]:
...
class multivariate_hypergeom_frozen(multi_rv_frozen):
    ...
    def rvs(self, size=..., random_state=...): # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[int, ...] | Any, dtype[Any]]:
        ...
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    **Fitting the distribution parameters**
    ...
    def rvs(self, mu=..., kappa=..., size=..., random_state=...): # -> Any | NDArray[Any] | ndarray[tuple[()], dtype[float64]] | NDArray[float64]:
        """Draw random samples from a von Mises-Fisher distribution.
...
class vonmises_fisher_frozen(multi_rv_frozen):
    ...
    def rvs(self, size=..., random_state=...): # -> Any | NDArray[Any] | ndarray[tuple[()], dtype[float64]] | NDArray[float64]:
...
class normal_inverse_gamma_gen(multi_rv_generic):
    ...
    def logpdf(self, x, s2, mu=..., lmbda=..., a=..., b=...): # -> ndarray[_AnyShape, dtype[Any]]:
        """Log of the probability density function.
    ...
    def pdf(self, x, s2, mu=..., lmbda=..., a=..., b=...): # -> ndarray[_AnyShape, dtype[Any]]:
    ...
    def mean(self, mu=..., lmbda=..., a=..., b=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[float64]]]:
        """The mean of the distribution.
    ...
    def var(self, mu=..., lmbda=..., a=..., b=...): # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
        """The variance of the distribution.
...
class normal_inverse_gamma_frozen(multi_rv_frozen):
    ...
    def mean(self): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[float64]]]:
        ...
    
    def var(self): # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
        ...

...
def find_repeats(arr): # -> tuple[NDArray[float64], NDArray[signedinteger[_NBitIntP]]] | tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[Incomplete]]]:
...
def rankdata(data, axis=..., use_missing=...): # -> ndarray[tuple[()], dtype[Incomplete]] | _Array1D[Incomplete]:
...
def kendalltau_seasonal(x): # -> dict[str, _MaskedArray[float64] | Any]:
    """
...
def trimr(a, limits=..., inclusive=..., axis=...): # -> _MaskedArray[Any] | MaskedArray[tuple[()], dtype[Any]]:
    """
...
trimdoc = ...
def trim(a, limits=..., inclusive=..., relative=..., axis=...): # -> _MaskedArray[Any] | MaskedArray[tuple[()], dtype[Any]]:
    """
    Trims an array by masking the data outside some given limits.
...
if trim.__doc__:
    ...
def trimboth(data, proportiontocut=..., inclusive=..., axis=...): # -> _MaskedArray[Any] | MaskedArray[tuple[()], dtype[Any]]:
    """
...
def trimtail(data, proportiontocut=..., tail=..., inclusive=..., axis=...): # -> _MaskedArray[Any] | MaskedArray[tuple[()], dtype[Any]]:
    """
...
if trimmed_mean.__doc__:
    ...
def trimmed_var(a, limits=..., inclusive=..., relative=..., axis=..., ddof=...): # -> Any:
...
if trimmed_var.__doc__:
    ...
def trimmed_std(a, limits=..., inclusive=..., relative=..., axis=..., ddof=...): # -> Any:
...
def winsorize(a, limits=..., inclusive=..., inplace=..., axis=..., nan_policy=...): # -> _MaskedArray[Any]:
...
def moment(a, moment=..., axis=...): # -> float64 | _MaskedArray[Any | float64] | _MaskedArray[float64]:
    """
...
def mquantiles(a, prob=..., alphap=..., betap=..., axis=..., limit=...): # -> _MaskedArray[Incomplete] | _MaskedArray[Any]:
    """
...
def scoreatpercentile(data, per, limit=..., alphap=..., betap=...): # -> MaskedArray[_AnyShape, dtype[Incomplete]] | MaskedArray[_AnyShape, dtype[Any]]:

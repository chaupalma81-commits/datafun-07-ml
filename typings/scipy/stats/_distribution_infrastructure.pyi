...
class _Interval(_Domain):
    ...
    def get_numerical_endpoints(self, parameter_values): # -> tuple[Any | Array, Any | Array]:
    ...
    def draw(self, n, type_, min, max, squeezed_base_shape, rng=...): # -> _Array1D[float64] | _Array[tuple[int], Any]:
...
class _Parameter(ABC):
   ...
   """
    ...
    def draw(self, size=..., *, rng=..., region=..., proportions=..., parameter_values=...): # -> ndarray[tuple[()], dtype[Any]]:
...
class _RealParameter(_Parameter):
    ...
    """
    def validate(self, arr, parameter_values): # -> tuple[ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[float64]], dtype[Any] | dtype[float64], Any]:
...
class UnivariateDistribution(_ProbabilityDistribution):
    ...
    def support(self): # -> tuple[ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    @_set_invalid_nan_property
    def entropy(self, *, method=...): # -> Callable[..., Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    
    @_set_invalid_nan_property
    def median(self, *, method=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any]]:
        ...
    
    @_set_invalid_nan_property
    def mode(self, *, method=...): # -> Callable[..., Any] | Callable[..., _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]]]:
        ...
    
    def mean(self, *, method=...): # -> _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]] | Any | None:
        ...
    
    def variance(self, *, method=...): # -> _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]] | Any | None:
        ...
    
    def standard_deviation(self, *, method=...):
        ...
    
    def skewness(self, *, method=...): # -> _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]] | Any | None:
        ...
    
    def kurtosis(self, *, method=..., convention=...): # -> ndarray[tuple[()], dtype[float64 | Any]] | ndarray[_AnyShape, dtype[Any]] | Any | None:
        ...
    ...
    @_set_invalid_nan
    def pmf(self, x, /, *, method=...): # -> Callable[..., Any]:
        ...
    
    def logcdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    
    def cdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    
    def logccdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., tuple[Any, Any] | Any]:
        ...
    
    def ccdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    @_set_invalid_nan
    def ilogccdf(self, logp, /, *, method=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any]]:
        ...
    
    @_set_invalid_nan
    def iccdf(self, p, /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any]:
        ...
    ...
    @_set_invalid_nan_property
    def moment(self, order=..., kind=..., *, method=...): # -> _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]] | Any | None:
        ...
...
def make_distribution(dist): # -> type[scipy.stats._distribution_infrastructure.CustomDistribution]:
...
class Mixture(_ProbabilityDistribution):
    ...
    def support(self): # -> tuple[ndarray[tuple[()], dtype[Any]] | NDArray[Incomplete], ndarray[tuple[()], dtype[Any]] | NDArray[Incomplete]]:
        ...
    ...
    def moment(self, order=..., kind=..., *, method=...): # -> ndarray[_AnyShape, dtype[Any]] | NDArray[float64]:
        ...
    ...
    def cdf(self, x, y=..., /, *, method=...): # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...
    
    def logcdf(self, x, y=..., /, *, method=...): # -> ndarray[_AnyShape, dtype[Any]]:
        ...
    
    def ccdf(self, x, y=..., /, *, method=...): # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...
    ...
    def sample(self, shape=..., *, rng=..., method=...): # -> ndarray[_AnyShape, dtype[Any]]:
        ...

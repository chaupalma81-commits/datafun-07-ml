...
class FitResult:
    ...
    def plot(self, ax=..., *, plot_type=...): # -> Axes:
...
def fit(dist, data, bounds=..., *, guess=..., method=..., optimizer=...): # -> FitResult:
...
def goodness_of_fit(dist, data, *, known_params=..., fit_params=..., guessed_params=..., statistic=..., n_mc_samples=..., rng=...): # -> GoodnessOfFitResult:
    r"""

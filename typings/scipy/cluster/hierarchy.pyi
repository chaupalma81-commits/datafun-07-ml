...
@lazy_cython
def cophenet(Z, Y=...): # -> tuple[Any, Any]:
    """
...
@lazy_cython
def from_mlab_linkage(Z): # -> scipy._lib._array_api.Array | scipy._lib.array_api_extra._lib._utils._typing.Array:
    """
...
@xp_capabilities(cpu_only=True, reason="Cython code", jax_jit=False, allow_dask_compute=True)
...
def dendrogram(Z, p=..., truncate_mode=..., color_threshold=..., get_leaves=..., orientation=..., labels=..., count_sort=..., distance_sort=..., show_leaf_counts=..., no_plot=..., no_labels=..., leaf_font_size=..., leaf_rotation=..., leaf_label_func=..., show_contracted=..., link_color_func=..., ax=..., above_threshold_color=...): # -> dict[str, list[Any] | None]:
    """
...
@xp_capabilities(cpu_only=True, reason="Cython code", jax_jit=False, warnings=[("dask.array", "merges chunks")])
def leaders(Z, T):
    """

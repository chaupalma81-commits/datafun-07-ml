...
abs = ...
def findfreqs(num, den, N, kind=...): # -> Any:
    """
...
def freqs(b, a, worN=..., plot=...): # -> tuple[Any | Array, Any]:
    """
...
def freqs_zpk(z, p, k, worN=...): # -> tuple[Array, Any]:
    """
    Compute frequency response of analog filter.
...
def freqz(b, a=..., worN=..., whole=..., plot=..., fs=..., include_nyquist=...): # -> tuple[Any | Array, Any]:
    """
...
def freqz_zpk(z, p, k, worN=..., whole=..., fs=...): # -> tuple[Any | Array, Any]:
    r"""
...
def group_delay(system, w=..., whole=..., fs=...): # -> tuple[Any, Any]:
...
def freqz_sos(sos, worN=..., whole=..., fs=...): # -> tuple[Any | Array, float | Any]:
    r"""
...
def sosfreqz(*args, **kwargs): # -> tuple[Any | Array, float | Any]:
    """
...
def tf2zpk(b, a): # -> tuple[Any, Any, Any | Array]:
...
def zpk2tf(z, p, k): # -> tuple[Any, Array]:
    r"""
...
def tf2sos(b, a, pairing=..., *, analog=...): # -> Any:
    r"""
...
def sos2zpk(sos): # -> tuple[Any | Array, Any | Array, float | Any]:
    """
...
def zpk2sos(z, p, k, pairing=..., *, analog=...): # -> Any:
...
def normalize(b, a): # -> tuple[Array, Array]:
...
def lp2lp(b, a, wo=...): # -> tuple[Array, Array]:
    r"""
...
def lp2hp(b, a, wo=...): # -> tuple[Array, Array]:
    r"""
...
def lp2bp(b, a, wo=..., bw=...): # -> tuple[Array, Array]:
    r"""
...
def lp2bs(b, a, wo=..., bw=...): # -> tuple[Array, Array]:
    r"""
...
def bilinear(b, a, fs=...): # -> tuple[Array, Array]:
...
def iirdesign(wp, ws, gpass, gstop, analog=..., ftype=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
...
def iirfilter(N, Wn, rp=..., rs=..., btype=..., analog=..., ftype=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def bilinear_zpk(z, p, k, fs): # -> tuple[Any, Any | Array, Any]:
    r"""
...
def lp2lp_zpk(z, p, k, wo=...): # -> tuple[Array, Array, Any]:
    r"""
    Transform a lowpass filter prototype to a different frequency.
...
def lp2hp_zpk(z, p, k, wo=...): # -> tuple[Any, Array, Any]:
    r"""
    Transform a lowpass filter prototype to a highpass filter.
...
def lp2bp_zpk(z, p, k, wo=..., bw=...): # -> tuple[Any, Any, Any]:
    r"""
    Transform a lowpass filter prototype to a bandpass filter.
...
def lp2bs_zpk(z, p, k, wo=..., bw=...): # -> tuple[Any, Any, Any]:
    r"""
    Transform a lowpass filter prototype to a bandstop filter.
...
def butter(N, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def cheby1(N, rp, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def cheby2(N, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def ellip(N, rp, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def bessel(N, Wn, btype=..., analog=..., output=..., norm=..., fs=...): # -> tuple[Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | scipy._lib.array_api_extra._lib._utils._typing.Array | scipy._lib.array_api_compat.numpy._typing.Array, Any | float] | tuple[Any, scipy._lib.array_api_extra._lib._utils._typing.Array] | Any | None:
    """
...
def buttord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any]:
...
def cheb2ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any]:
...
def buttap(N, *, xp=..., device=...): # -> tuple[Array | Any, Any, float]:
...
def cheb1ap(N, rp, *, xp=..., device=...): # -> tuple[Array | Any, Array | Any, Any] | tuple[Array | Any, Any, Any]:
    """
...
def cheb2ap(N, rs, *, xp=..., device=...): # -> tuple[Array | Any, Array | Any, float] | tuple[Any, Any, Any]:
    """
...
_ELLIPDEG_MMAX = ...
_ARC_JAC_SN_MAXITER = ...
def ellipap(N, rp, rs, *, xp=..., device=...): # -> tuple[Array | Any, Array | Any, Any] | tuple[Array | Any, Array | Any, float]:
...
def besselap(N, norm=..., *, xp=..., device=...): # -> tuple[Array | Any, Array | Any, float]:
    """
...
def iirnotch(w0, Q, fs=..., *, xp=..., device=...): # -> tuple[NDArray[complexfloating[Any, Any]] | Any, Array | Any]:
    """
...
def iirpeak(w0, Q, fs=..., *, xp=..., device=...): # -> tuple[NDArray[complexfloating[Any, Any]] | Any, Array | Any]:
    """
...
def iircomb(w0, Q, ftype=..., fs=..., *, pass_zero=..., xp=..., device=...): # -> tuple[Array | Any, Array | Any]:
    """
...
def gammatone(freq, ftype, order=..., numtaps=..., fs=..., *, xp=..., device=...): # -> tuple[Array | Any, Array | Any]:
    """

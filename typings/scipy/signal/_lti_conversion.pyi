...
def tf2ss(num, den): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any], NDArray[Any]] | tuple[_Array[tuple[int, int], float64], _Array[tuple[int, int], float64], _Array[tuple[int, int], float64], NDArray[Any]] | tuple[Incomplete, _Array2D[float64], Any, ndarray[tuple[int, int], dtype[Any]]]:
...
def zpk2ss(z, p, k): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any], NDArray[Any]] | tuple[_Array[tuple[int, int], float64], _Array[tuple[int, int], float64], _Array[tuple[int, int], float64], NDArray[Any]] | tuple[Incomplete, _Array2D[float64], Any, ndarray[tuple[int, int], dtype[Any]]]:

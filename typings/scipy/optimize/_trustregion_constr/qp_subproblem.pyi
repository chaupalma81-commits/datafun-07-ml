...
def box_sphere_intersections(z, d, lb, ub, trust_radius, entire_line=..., extra_info=...): # -> tuple[Incomplete, Incomplete, bool, dict[str, float | Any | int | bool], dict[str, int | Any | bool]] | tuple[Incomplete, Incomplete, bool]:
...
def projected_cg(H, c, Z, Y, b, trust_radius=..., lb=..., ub=..., tol=..., max_iter=..., max_infeasible_iter=..., return_all=...): # -> tuple[Any, dict[str, int | bool]]:

...
def strict_bounds(lb, ub, keep_feasible, n_vars): # -> tuple[ndarray[tuple[int], dtype[Any]], ndarray[tuple[int], dtype[Any]]]:
    """Remove bounds which are not asked to be kept feasible."""
    ...

def new_constraint_to_old(con, x0): # -> list[dict[str, str | Callable[..., NDArray[Incomplete]]]]:
    """

...
line_search = ...
def line_search_wolfe2(f, myfprime, xk, pk, gfk=..., old_fval=..., old_old_fval=..., args=..., c1=..., c2=..., amax=..., extra_condition=..., maxiter=...): # -> tuple[Any | float | None, int, int, Any, Any | None, None]:
...
def scalar_search_wolfe2(phi, derphi, phi0=..., old_phi0=..., derphi0=..., c1=..., c2=..., amax=..., extra_condition=..., maxiter=...): # -> tuple[Any | float | None, Any, Any | None, Any | None]:
    """Find alpha that satisfies strong Wolfe conditions.
...
def scalar_search_armijo(phi, phi0, derphi0, c1=..., alpha0=..., amin=...):
